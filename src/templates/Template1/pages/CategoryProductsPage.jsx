...
const CategoryProductsPage = () => {
  ...
  const handleBackToCategories = () => {
    navigate('/template1/products');
  };

  const handleProductClick = (product) => {
    const productSlug = createProductSlug(product);
    navigate(`/template1/products/${categorySlug}/${productSlug}`, {
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div
                      className="group flex items-center justify-center gap-2 px-6 py-3 cursor-pointer border transition-all duration-300 hover:shadow-xl mt-4 text-white"
