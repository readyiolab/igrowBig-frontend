  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Transform API data to match the template structure
        const transformedData = {
          hero_section_title: homeData.hero_title || "Do you know what it means to have Dream Life?",
          hero_section_content: homeData.hero_description || "<p>Living the Best Life means <strong>Excellent Health</strong>, Better Financial Potential, Enriching Personal Relationships and the freedom to spend YOUR time enjoying what makes you happy... we call that a <strong>Dream Life</strong>!</p>",
          hero_banner_image_url: homeData.hero_image_url || "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1200&h=500&fit=crop",
          hero_button_text: homeData.hero_button_text || "Get Started Today",

          welcome_section_title: homeData.welcome_title || "Welcome to Get Dream Life",
          welcome_section_content: homeData.welcome_description || "<p>Get Dream Life (GDL) welcomes to the world of opportunity and infinite potential for a great life. Yes, we mean it, '<strong>Infinite Human Potential</strong>'. If you're worried about job security, interested in extra income opportunities or looking for a change in your professional career, your worries stop here. You are at the right place.</p>",
          welcome_section_image_url: homeData.welcome_image_url || "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=600&h=400&fit=crop",

          about_section_title: homeData.about_company_title || "About NHT Global",
          about_section_content: homeData.about_company_content_1 || "<p>NHT Global mission is to improve the way you feel- about yourself and about work. Providing effective, quality-of-life products for our customers and possibly the most lucrative compensation plan ever for the members and committed to the wellness of people across the globe.</p>",
          about_section_image_url: homeData.about_company_image_url || "https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=600&h=400&fit=crop",

          history_section_title: homeData.history_title || "History of NHT Global",
          history_section_content: homeData.history_content || "<p><strong>Started in 2001</strong>, global headquarters in Los Angeles, California</p>",
          history_section_image_url: homeData.history_image_url || "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&h=400&fit=crop",

          video_section_title: homeData.opportunity_video_header_title || "Watch NHT Global Video",
          video_section_youtube_url: homeData.opportunity_video_url?.includes('youtube') ? homeData.opportunity_video_url : null,
          video_section_file_url: homeData.opportunity_video_url && !homeData.opportunity_video_url?.includes('youtube') ? homeData.opportunity_video_url : null,

          help_section_title: homeData.support_title || "How Get Dream Life Can Help",
          help_section_content: homeData.support_content || "<p>We are team of professional believe in your success is our success. Will provide you all possible support like:</p>",
          help_section_image_url: homeData.support_image_url || "https://images.unsplash.com/photo-1556761175-b413da4baf72?w=600&h=400&fit=crop",
        };
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="relative transform transition-transform duration-500">
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(to top, rgba(190, 49, 68, 0.2), transparent)",
                  }}
                ></div>
              </div>
            </div>
