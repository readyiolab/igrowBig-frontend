...
const HomepageHeroSection = lazy(() =>
  import("@/components/backoffice/pages/HomepageHeroSection")
);
const HomepageWelcomeSection = lazy(() =>
  import("@/components/backoffice/pages/HomepageWelcomeSection")
);
const HomepageAboutSection = lazy(() =>
  import("@/components/backoffice/pages/HomepageAboutSection")
);
const HomepageHistorySection = lazy(() =>
  import("@/components/backoffice/pages/HomepageHistorySection")
);
const HomepageVideoSection = lazy(() =>
  import("@/components/backoffice/pages/HomepageVideoSection")
);
const HomepageHelpSection = lazy(() =>
  import("@/components/backoffice/pages/HomepageHelpSection")
);
...
const OpportunityHeroSection = lazy(() =>
  import("@/components/backoffice/pages/OpportunityHeroSection")
);
const OpportunityDescriptionSection = lazy(() =>
  import("@/components/backoffice/pages/OpportunityDescriptionSection")
);
const OpportunityDoorSection = lazy(() =>
  import("@/components/backoffice/pages/OpportunityDoorSection")
);
const OpportunityMarketingSection = lazy(() =>
  import("@/components/backoffice/pages/OpportunityMarketingSection")
);
const OpportunityBusinessModelSection = lazy(() =>
  import("@/components/backoffice/pages/OpportunityBusinessModelSection")
);
const OpportunityVideoSection = lazy(() =>
  import("@/components/backoffice/pages/OpportunityVideoSection")
);
const OpportunityCompensationPlan = lazy(() =>
  import("@/components/backoffice/pages/OpportunityCompensationPlan")
);
...
const EcommerceCategoryProductsPage = lazy(() =>
  import("@/templates/Template1/pages/CategoryProductsPage")
);
const EcommerceProductDetail = lazy(() =>
  import("@/templates/Template1/pages/ProductDetailPage")
);
const EcommerceOpportunity = lazy(() =>
  import("@/templates/Template1/pages/Opportunity")
);
const EcommerceOpportunityOverView = lazy(() =>
  import("@/templates/Template1/pages/OpportunityOverview")
);
...
const EcommerceProducts2 = lazy(() =>
  import("@/templates/Template2/pages/ProductsPage ")
);
...
const EcommerceOpportunityOverView2 = lazy(() =>
  import("@/templates/Template2/pages/OpportunityOverview")
);
...
const router = createBrowserRouter([
  ...
  protect(
    {
      ...
      children: [
        ...
        { path: "footer-disclaimer", element: wrap(FooterEditor)() },
        {
          ...
          element: wrap(SubscriberMessagePlaceholder)(),
        },
  ...
  // DEMO TEMPLATE2
  {
    ...
    children: [
      ...
      {
        path: "opportunity-overview",
        element: wrap(EcommerceOpportunityOverView2)(),
      },
